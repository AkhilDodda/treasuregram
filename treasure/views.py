...
def profile(request,username):
	...
	return render(request,'profile.html',{'username':username,'treasures':treasures,'form':form})
	...
	if request.method=='POST':
		...
		if form.is_valid():
			...
			if user is not None:
				...
				messages.warning(request, 'Username and Password are incorrect',extra_tags='alert')
				return HttpResponseRedirect('/')
	else:
		form=LoginForm()
